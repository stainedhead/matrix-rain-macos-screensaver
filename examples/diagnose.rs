...
fn main() {
    ...
    println!(
        "   LANG: {}",
        env::var("LANG").unwrap_or_else(|_| "NOT SET".to_string())
    );
    println!(
        "   COLORTERM: {}",
